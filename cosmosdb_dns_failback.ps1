...
Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet_global -Ipv4Address $cosmosdb_global_endpoint_primary_region_IP
Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet_primary_region -Ipv4Address $cosmosdb_primary_endpoint_primary_region_IP
Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet_secondary_region -Ipv4Address $cosmosdb_secondary_endpoint_primary_region_IP
...
Remove-AzPrivateDnsRecordConfig -RecordSet $RecordSet_global -Ipv4Address $cosmosdb_global_endpoint_secondary_region_IP
Remove-AzPrivateDnsRecordConfig -RecordSet $RecordSet_primary_region -Ipv4Address $cosmosdb_primary_endpoint_secondary_region_IP
Remove-AzPrivateDnsRecordConfig -RecordSet $RecordSet_secondary_region -Ipv4Address $cosmosdb_secondary_endpoint_secondary_region_IP
